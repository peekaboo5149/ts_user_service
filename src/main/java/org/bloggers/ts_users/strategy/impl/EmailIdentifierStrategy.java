...
class EmailIdentifierStrategy implements UserIdentifierStrategy {

    private final UserProfileRepository userProfileRepository;

    @Override
    public Optional<UserProfile> find(String email) {
        return userProfileRepository.findByCredentialsEmail(email);
    }
}
